...
public class Events {
    ...
    public static final short ConfirmUsernameMessageEvent = 3878; // 1590 // IN PRODUCTION 201611 = 3878
    ...
    public static final short SSOTicketMessageEvent = 2419; // 286 // IN PRODUCTION 201611 = 2419
    ...
    public static final short UniqueIDMessageEvent = 2490; // 921 IN PRODUCTION 201611 = 2490
    ...
    public static final short EventLogMessageEvent = 3457; // 658 // IN PRODUCTION 201611 = 3457
    ...
    public static final short GetRoomEntryDataMessageEvent = 2300; // 2300
    ...
    public static final short InitCryptoMessageEvent = 2688; // 3347 // IN PRODUCTION 201611 = 2688
