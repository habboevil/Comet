...
public class CraftingMachine {
    ...
    public Map<Integer, String> getAllowedItems() {
        return this.allowedItems;
    }

    public List<CraftingRecipe> getPublicRecipes() {
        return this.publicRecipes;
    }

    public List<CraftingRecipe> getSecretRecipes() {
    ...
    public CraftingRecipe getRecipeByProductData(String productData) {
        ...
        for (final CraftingRecipe recipe : this.publicRecipes) {
