...
public class PlayerInfoCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] params) {
        ...
        userInfo.append("<b>").append(Locale.getOrDefault("command.playerinfo.username", "USer")).append("</b>: ").append(playerData.getUsername()).append("<br>");
        userInfo.append("<b>").append(Locale.getOrDefault("command.playerinfo.motto", "Motto")).append("</b>: ").append(playerData.getMotto()).append("<br>");
        userInfo.append("<b>").append(Locale.getOrDefault("command.playerinfo.gender", "Gender")).append("</b>: ").append(playerData.getGender().equalsIgnoreCase("m") ? Locale.getOrDefault("command.playerinfo.male", "Homem") : Locale.getOrDefault("command.playerinfo.female", "Mulher")).append("<br>");
        userInfo.append("<b>").append(Locale.getOrDefault("command.playerinfo.status", "status")).append("</b>: ").append(session == null ? Locale.getOrDefault("command.playerinfo.offline", "Offline") : Locale.getOrDefault("command.playerinfo.online", "Online")).append("<br>");
        userInfo.append("<b>").append(Locale.getOrDefault("command.playerinfo.achievementPoints", "Achievement Points")).append("</b>: ").append(playerData.getAchievementPoints()).append("<br>");
        userInfo.append("<b>").append(Locale.getOrDefault("command.playerinfo.vip", "VIP")).append("</b>: ").append(playerData.isVip()).append("<br>");

        if (client.getPlayer().getPermissions().getRank().modTool()) {
            userInfo.append("<b>").append(Locale.getOrDefault("command.playerinfo.rank", "Rango")).append("</b>: ").append(playerData.getRank()).append("<br>");
        }
        ...
        userInfo.append("<i>").append(playerData.getSeasonalPoints()).append(" ").append(Locale.getOrDefault("command.playerinfo.seasonalPoints", "seasonal")).append("</i><br><br>");
        userInfo.append("<i>").append(playerData.getPlayer().getStats().getLevel()).append(" ").append(Locale.getOrDefault("command.playerinfo.level", "level:")).append("</i><br>");
