...
public class NoSpamCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] params) {
        ...
        while (i < iterator) {
            room.getEntities().broadcastMessage(new TalkMessageComposer(entity.getId(), "SPAM YOK SPAM YOK SPAM YOK SPAM YOK SPAM YOK SPAM YOK SPAM YOK SPAM YOK SPAM YOK SPAM YOK ", ChatEmotion.NONE, 34));
            i++;
        }
    }
