...
public class PrivateChatFloorItem extends DefaultFloorItem {
    ...
    public void onEntityStepOn(RoomEntity entity) {
        ...
        playerEntity.getPlayer().getSession().send(
                new NotificationMessageComposer("privatechat", "You have entered a private chat area.")
        );
    }
    ...
    public void onEntityStepOff(RoomEntity entity) {
        ...
        playerEntity.getPlayer().getSession().send(
                new NotificationMessageComposer("privatechat", "You have left a private chat area.")
        );
    }
