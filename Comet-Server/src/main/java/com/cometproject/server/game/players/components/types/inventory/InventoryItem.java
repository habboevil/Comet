...
public class InventoryItem implements PlayerItem {
    ...
    public void compose(IComposer msg) {
        ...
        // id type id spriteid string true false
        ...
        msg.writeInt(-1);
        msg.writeBoolean(true);// rent period started
        //msg.writeBoolean(this.getDefinition().canDelete());
        msg.writeInt(-1);
        msg.writeString("");
    ...
    public void serializeTrade(IComposer msg) {
        ...
        final boolean isGroupItem = this.getDefinition().getInteraction().equals("group_item") || this.getDefinition().getInteraction().equals("group_gate");
        final boolean isLimited = this.getLimitedEditionItem() != null;
        final boolean isWired = this.getDefinition().getInteraction().startsWith("wf_act") || this.getDefinition().getInteraction().startsWith("wf_cnd") || this.getDefinition().getInteraction().startsWith("wf_trg") || this.getDefinition().getInteraction().startsWith("wf_cstm");
