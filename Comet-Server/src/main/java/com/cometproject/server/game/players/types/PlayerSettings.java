...
public class PlayerSettings implements IPlayerSettings {
    ...
    private boolean disableHotelAlert;
    private boolean disableHotelAlertLinks;
    ...
    public PlayerSettings(ResultSet data, boolean isLogin, Player player) throws SQLException {
        if (isLogin) {
            ...
            this.disableHotelAlert = data.getString("playerSettings_disableHotelAlert").equalsIgnoreCase("1");
            this.disableHotelAlertLinks = data.getString("playerSettings_disableHotelAlertLinks").equalsIgnoreCase("1");
    ...
    public PlayerSettings() {
        ...
        this.disableHotelAlert = false;
        this.disableHotelAlertLinks = false;
        this.bubbleId = 0;
    ...
    public int getNuxStatus() {
        return this.nuxStatus;
    }

    public void incrementNuxStatus() {
        this.nuxStatus++;
    }
    ...
    @Override
    public boolean disableHotelAlert() {
        return disableHotelAlert;
    }

    @Override
    public void setDisableHotelAlert(boolean disableHotelAlert) {
        this.disableHotelAlert = disableHotelAlert;

        flush();
    }

    @Override
    public boolean disableHotelAlertLinks() {
        return disableHotelAlertLinks;
    }

    @Override
    public void setDisableHotelAlertLinks(boolean disableHotelAlertLinks) {
        this.disableHotelAlertLinks = disableHotelAlertLinks;
