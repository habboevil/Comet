...
public class CraftingRecipe {
    ...
    public CraftingRecipeMode getMode() {
        return this.mode;
    }
    ...
    public String getResultProductData() {
        return this.resultProductData;
    }

    public int getResultBaseId() {
        return this.resultBaseId;
    }

    public int getResultLimitedSells() {
        return this.resultLimitedSells;
    }

    public int getResultTotalCrafted() {
        return this.resultTotalCrafted;
    }

    public void increateTotalCrafted() {
        this.resultTotalCrafted++;
    }
