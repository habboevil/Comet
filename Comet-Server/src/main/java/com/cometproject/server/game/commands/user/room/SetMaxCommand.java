...
public class SetMaxCommand extends ChatCommand {
    ...
    public String getParameter() {
        return Locale.getOrDefault("command.parameter.amount", "(Quantity)");
    }

    @Override
    public String getDescription() {
        return Locale.getOrDefault("command.setmax.description", "Set the maximum number of users in your room");
    }
}
