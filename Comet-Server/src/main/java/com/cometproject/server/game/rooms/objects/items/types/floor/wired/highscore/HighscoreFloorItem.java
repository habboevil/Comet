...
public abstract class HighscoreFloorItem extends RoomItemFloor {
    ...
    HighscoreFloorItem(RoomItemData roomItemData, Room room) {
        ...
        if (roomItemData.getData().startsWith("1{") || roomItemData.getData().startsWith("0{")) {
            ...
            this.state = false;
            this.itemData = new ScoreboardItemData(Comet.getTime(), Lists.newCopyOnWriteArrayList(), new LinkedHashMap<>());
        }
    ...
    public abstract void onTeamWins(List<String> users, List<PlayerEntity> players, int score);
