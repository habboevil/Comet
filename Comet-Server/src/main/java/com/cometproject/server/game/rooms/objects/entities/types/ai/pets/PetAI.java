...
public class PetAI extends AbstractBotAI {
    ...
    public boolean onAddedToRoom() {
        ...
        if (playerEntity != null) {
            ...
            if (tile != null) {
                ...
                tile.scheduleEvent(this.getPetEntity().getId(), (entity) -> entity.lookTo(playerEntity.getPosition().getX(), playerEntity.getPosition().getY()));
            }
        }
    ...
    public void tryEat() {
        ...
        if (decreaseHappiness && RandomUtil.getRandomBool(0.5)) {
            this.applyGesture(PetGesture.SAD.getGestureKey());
...
//        if (!this.getPetEntity().isWalking())
    ...
    public void onScratched() {
        ...
        this.applyGesture(PetGesture.SMILE.getGestureKey());
    ...
    public void increaseExperience(int amount) {
        ...
        if (levelled) {
            this.applyGesture(PetGesture.LEVEL_UP.getGestureKey());
        }
    }
