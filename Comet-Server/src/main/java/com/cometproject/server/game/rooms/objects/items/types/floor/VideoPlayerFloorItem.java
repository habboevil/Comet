...
public class VideoPlayerFloorItem extends DefaultFloorItem {
    ...
    public boolean onInteract(RoomEntity entity, int requestData, boolean isWiredTrigger) {
        ...
        YoutubeTVComposer msg = new YoutubeTVComposer(this.getItemData().getData() == null ? "" : this.getItemData().getData(), playerEntity.hasRights() || playerEntity.getPlayer().getPermissions().getRank().roomFullControl() ? this.getVirtualId() : 0);
