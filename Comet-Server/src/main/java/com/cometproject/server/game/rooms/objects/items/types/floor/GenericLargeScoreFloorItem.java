...
public class GenericLargeScoreFloorItem extends RoomItemFloor {
    public final int SCORE_LIMIT = 999;

    public GenericLargeScoreFloorItem(RoomItemData itemData, Room room) {
        super(itemData, room);
    }
