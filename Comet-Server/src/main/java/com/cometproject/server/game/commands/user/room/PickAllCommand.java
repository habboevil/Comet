...
public class PickAllCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] message) {
        ...
        this.logDesc = "The staff %s has made pickall in the room '%b', whose owner is %c"
    ...
    public String getDescription() {
        return Locale.getOrDefault("command.pickall.description", "Collect all the furnis from your living room.");
    }
