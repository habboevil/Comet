            ...
            if (isPlayer) {
                ...
                if (((PlayerEntity) entity).isAway()) {
                    ...
                    if ((currentTime - ((PlayerEntity) entity).getLastAwayReminder()) >= 60) {
                        this.getRoom().getEntities().broadcastChatMessage(new TalkMessageComposer(entity.getId(), String.format("%s dakikadır AFK'yım.", TimeSpan.millisecondsToDate(((PlayerEntity) entity).getAwayTime())), ChatEmotion.NONE, 0), ((PlayerEntity) entity));
