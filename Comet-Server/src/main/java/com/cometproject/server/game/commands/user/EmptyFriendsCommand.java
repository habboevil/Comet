...
public class EmptyFriendsCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] params) {
        ...
        for (final Integer playerId : client.getPlayer().getMessenger().getFriends().keySet()) {
    ...
    public String getDescription() {
        return Locale.getOrDefault("command.emptyfriends.description", "Delete all your friends you have added");
    }
}
