...
public class WiredCustomGiveActivityPoints extends WiredActionItem {

    public WiredCustomGiveActivityPoints(RoomItemData itemData, Room room) {
        super(itemData, room);
    }
    ...
    public void onEventComplete(WiredItemEvent event) {
        ...
        try {
            playerEntity.getPlayer().getData().increaseActivityPoints(Integer.parseInt(this.getWiredData().getText()));
