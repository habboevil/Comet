...
public class FigureData {
    public final Map<Integer, FiguredataPalette> palettes;
    public final Map<SetType, FiguredataSettype> settypes;
    ...
    public void parseXML(String uri) throws Exception {
        ...
        for (int i = 0; i < settypesList.getLength(); i++) {
            ...
            if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                ...
                SetType type = SetType.fromString(element.getAttribute("type"));
                ...
                for (int ii = 0; ii < setsList.getLength(); ii++) {
                    if (setsList.item(ii).getNodeType() == Node.ELEMENT_NODE) {
                        ...
                        FiguredataSettypeSet set = new FiguredataSettypeSet(
                                ...
                                FigureGender.fromString(setElement.getAttribute("gender")),
