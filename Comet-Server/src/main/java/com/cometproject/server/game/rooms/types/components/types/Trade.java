...
public class Trade {
     ...
     */
    private final PlayerEntity user1;
    private final PlayerEntity user2;
    /**
     * The items which the entities are trading
     */
    private final Set<PlayerItem> user1Items;
    private final Set<PlayerItem> user2Items;
    /**
    ...
    public void complete() {
        ...
        for (PlayerItem item : this.user1Items) {
            ...
            PlayerDao.saveTradeLog(this.user2.getPlayer().getId(), this.user1.getPlayer().getId(), item.getBaseId(), item.getId(), (int) Comet.getTime());
        }
        ...
        for (PlayerItem item : this.user2Items) {
            ...
            PlayerDao.saveTradeLog(this.user1.getPlayer().getId(), this.user2.getPlayer().getId(), item.getBaseId(), item.getId(), (int) Comet.getTime());
