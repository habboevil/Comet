...
public class DeleteGroupCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] params) {
        ...
        this.logDesc = "Staff %s deleted group %b whose room is %d"
    ...
    public String getDescription() {
        return Locale.getOrDefault("command.deletegroup.description", "Delete the group you created in your room");
    }
