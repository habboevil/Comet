...
public class PlayerEntity extends RoomEntity implements PlayerEntityAccess, Attributable, PlayerRoomEntity {
    ...
    protected void finalizeJoinRoom() {
        ...
        if (this.getRoom().getData().getRoomProcessType() != RoomProcessingType.DEFAULT) {
            this.getPlayer().sendBubble("generic", "The Player of this room has been changed to " + this.getRoom().getData().getRoomProcessType().getName() + "!");
        }
    }
    ...
    private void sendTraxMachineSong() {
        ...
        try {
            ...
            this.getPlayer().getSession().send(new NotificationMessageComposer("traxmachine", "Drop the Sound, DJ! TraxMachine in the area."));
...
//            }
    ...
    public void compose(IComposer msg) {
        // int str str str int int int str int int
        ...
        // int str str str int int str int int str int int str  str int str bool
        // id username custom figure roomindex x y z dir type sex groupid groupstatus groupname swimfigure activitypoints ismoderator

        // int str str str int int (str) int str int int  int int str str int bool
        // id username motto figure id x y z rot type gender groupid status groupname swimfigure activitypoints
