...
public class WiredCustomGiveSeasonalPoints extends WiredActionItem {

    public WiredCustomGiveSeasonalPoints(RoomItemData itemData, Room room) {
        super(itemData, room);
    }
    ...
    public void onEventComplete(WiredItemEvent event) {
        ...
        playerEntity.getPlayer().getData().increaseSeasonalPoints(number);
