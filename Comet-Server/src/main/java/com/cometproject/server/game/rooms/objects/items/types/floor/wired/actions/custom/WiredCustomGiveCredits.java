...
public class WiredCustomGiveCredits extends WiredActionItem {

    public WiredCustomGiveCredits(RoomItemData itemData, Room room) {
        super(itemData, room);
    }
    ...
    public void onEventComplete(WiredItemEvent event) {
        ...
        try {
            playerEntity.getPlayer().getData().increaseCredits(Integer.parseInt(this.getWiredData().getText()));
