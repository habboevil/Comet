...
public class BundleCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] params) {
        if (params.length < 2) {
            client.send(new AlertMessageComposer(Locale.getOrDefault("command.bundle.create", "Utilize ':bundle create [name]' to create the bundle.")));
            return;
        }
        ...
        switch (commandName) {
            case "create": {
                ...
                this.logDesc = "%s ran bundle command with name %n in room '%b'"
