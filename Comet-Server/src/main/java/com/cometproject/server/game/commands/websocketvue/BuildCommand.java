...
public class BuildCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] params) {
        ...
        sendWhisper(Locale.getOrDefault("command.build_websocket.enabled", "Build mode enabled."), client);
    ...
    public String getDescription() {
        return Locale.getOrDefault("command.build.description", "Tool in order to facilitate constructions.");
    }
}
