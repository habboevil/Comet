...
public class FeaturedRoom {
    ...
    public FeaturedRoom(int id, String caption, String description, String image, ImageType imageType, int roomId, int categoryId, boolean enabled, boolean recommended, boolean isCategory) {
        this.id = id;
