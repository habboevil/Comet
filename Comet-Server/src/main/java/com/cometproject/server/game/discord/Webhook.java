package com.cometproject.server.game.discord;
...
public class Webhook {
    ...
    public static class EmbedObject {
        ...
        public EmbedObject addMultipleFields(Map<String, String> fields) {
            for (final Map.Entry<String, String> field : fields.entrySet()) {
                this.addField(field.getKey(), field.getValue(), false);
            }
