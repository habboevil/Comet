...
public class Player extends Observable implements IPlayer {
    ...
    @Override
    public void setLastSpin(int lastSpin) {
    ...
    @Override
    public void setLastCommandRoleplay(int lastCommandRoleplay) {
        this.lastCommandRoleplay = lastCommandRoleplay;
    }
    ...
    public boolean getLogsClientStaff() {
        return logsClientStaff;
    }

    public void setLogsClientStaff(boolean logsClientStaff) {
        this.logsClientStaff = logsClientStaff;
    }
    ...
    public boolean needsReceivePeriodicRewards() {
        return (Comet.getTime() - this.getLastReward()) >= (CometSettings.onlineRewardInterval * 60L);
    }

    public boolean isVip() {
        return this.getData().getRank() == CometSettings.vipRank;
    }
}
