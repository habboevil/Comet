...
public abstract class BotData implements IBotData {
    ...
    /**
     * Will messages go out randomly?
     */
    private boolean isRandomMessages;
    /**
     ...
     */
    public BotData(int id, String username, String motto, String figure, String gender, String ownerName, int ownerId, String messages, boolean automaticChat, boolean isRandomMessages, int chatDelay, BotType botType, BotMode mode, String data) {
        this.id = id;
        ...
        this.isRandomMessages = isRandomMessages;
    }
    ...
    public JsonObject toJsonObject() {
        ...
        jsonObject.addProperty("isRandomMessages", this.isRandomMessages);
    ...
    public boolean isRandomMessages() {
        return isRandomMessages;
    }

    @Override
    public void setRandomMessages(boolean isRandomMessages) {
        this.isRandomMessages = isRandomMessages;
    }
