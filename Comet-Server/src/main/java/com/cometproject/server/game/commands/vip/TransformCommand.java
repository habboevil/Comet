...
public class TransformCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] params) {
        ...
        if (option.equalsIgnoreCase("list")) {
            ...
            sendAlert(Locale.getOrDefault("command.transform.list", "List of available pets:\n%pets").replace("%pets", String.join("\n", names)), client);
            return;
        }
        ...
        if (option.equalsIgnoreCase("human")) {
            ...
            if (data == null || data.isEmpty()) {
                sendWhisper(Locale.getOrDefault("command.transform.notexists", "Oops! This pet name does not exist."), client);
                return;
            }
    ...
    public String getDescription() {
        return Locale.getOrDefault("command.transform.description", "Transform into a Pet");
    }
