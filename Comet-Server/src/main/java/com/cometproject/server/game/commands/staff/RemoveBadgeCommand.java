...
public class RemoveBadgeCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] params) {
        ...
        if (session != null) {
            ...
            sendNotif(Locale.getOrDefault("command.removebadge.userisoff", "This user is offline, you can only remove badges from online users."), client);
        }

        if (!CometExternalSettings.enableStaffMessengerLogs) return;

        this.logDesc = "-c removed -d badge from user -e"
    ...
    public String getParameter() {
        return Locale.getOrDefault("command.parameter.username" + " " + "command.parameter.badge", "(user) (badge)");
    }
