...
public class TreeGameObject extends GameItemObject {
    ...
    private static final int[] _jU = new int[]{0};
    private static final int[] _2Kl = new int[]{((Tile.TILE_SIZE - SnowBallGameObject.boundingData[0]) - 1)};
