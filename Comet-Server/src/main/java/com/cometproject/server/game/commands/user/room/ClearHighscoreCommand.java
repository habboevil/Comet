...
public class ClearHighscoreCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] message) {
        ...
        client.send(new NotificationMessageComposer("highscore", "You have successfully reset the room classifiers."));
    }
    ...
    public String getDescription() {
        return Locale.getOrDefault("command.highscore.description", "Clean up the scoreboards you have in your room");
    }
}
