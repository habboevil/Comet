    ...
    public void handle(Session client, MessageEvent msg) throws Exception {
        ...
        switch (voucher.getType()) {
            case SEASONAL_POINTS: {
                ...
                client.send(new AdvancedAlertMessageComposer(Locale.get("command.seasonal.title"), Locale.get("command.seasonal.received").replace("%amount%", String.valueOf(seasonalAmount))));
                break;
            }
