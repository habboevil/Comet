        ...
        switch (action) {
            ...
            case 2:
                ...
                if (speakingInterval < CometSettings.minimumBotMessagesDelay) {
                    ...
                    client.sendQueue(new NotificationMessageComposer("generic", Locale.getOrDefault("bot.alert.minimumBotMessagesDelay", "The delay of the messages was returned to the default value.")));
                }
...
//                    }
            ...
            case 5:
                ...
                if (botName.length() == 0 || botName.length() > CometSettings.minimumBotNameLength) {
                    client.sendQueue(new NotificationMessageComposer("generic", Locale.getOrDefault("bot.alert.invalidName", "Fill in a valid name")));
                    return;
                }
