        ...
        if (CometSettings.bonusBagEnabled) {
            ...
            if (client.getPlayer().getData().getBonusPoints() == points) {
                ...
                if (itemDefinition != null) {
                    ...
                    e.getSession().send(new NotificationMessageComposer("bonusbag.", "You got the furni " + CometSettings.bonusRewardName + " for having completed " + CometSettings.bonusHours + " hours connected."));
                }
            }
        }
    }
