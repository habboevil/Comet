...
public class RemovePetMessageEvent implements Event {
    ...
    public void handle(Session client, MessageEvent msg) throws Exception {
        ...
        if (entity instanceof MonsterPlantEntity && (pet = (PetMonsterPlantData) entity.getData()) != null && !pet.isDead()) {
            client.send(new WhisperMessageComposer(-1, Locale.getOrDefault("cant.pickup.seeds", "You can not collect seeds once planted, be aware of the consequences."), 34));
            return;
        }
