    ...
    public void handle(Session client, MessageEvent msg) throws Exception {
        ...
        if (client.getPlayer().getId() != entity.getData().getOwnerId()) {
            ...
            if (ownerSession == null) {
                client.send(new NotificationMessageComposer("generic", Locale.getOrDefault("bots.pickup.deny", "You can't remove this bot at this time.")));
                return;
            }
            ...
            ownerSession.send(new NotificationMessageComposer("generic", Locale.getOrDefault("bots.pickup.for.staff", "One of their BOTs was collected by Team Staff.")));
