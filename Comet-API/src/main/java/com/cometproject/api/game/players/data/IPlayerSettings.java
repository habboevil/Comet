...
public interface IPlayerSettings {
    ...
    boolean disableHotelAlert();

    void setDisableHotelAlert(boolean disableHotelAlert);

    boolean disableHotelAlertLinks();

    void setDisableHotelAlertLinks(boolean disableHotelAlertLinks);
}
