...
public abstract class MySQLRepository {
    protected final Logger log = LogManager.getLogger(MySQLRepository.class.getName());
    ...
    private void addParameters(PreparedStatement preparedStatement, Object... parameters) throws Exception {
        ...
        for (Object obj : parameters) {
            if (obj instanceof Integer) {
                ...
                log.info("You can only bind types: Integer, String, Boolean, Long and Double to a statement!");
            }
        }
    }
}